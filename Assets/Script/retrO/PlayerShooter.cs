...
public class PlayerShooter : MonoBehaviour
{
    ...
    {
        if (gun == null || UIManager.GetInstance == null) return;

        // UI 매니저의 탄약 텍스트에 탄창의 탄약과 남은 전체 탄약을 표시
        //UIManager.GetInstance.UpdateAmmoText(gun.magAmmo, gun.ammoRemain);

        //UIManager.GetInstance.SetActiveCrosshair(hasEnoughDistance);
        //UIManager.GetInstance.UpdateCrossHairPosition(aimPoint);
    }
